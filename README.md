...
- [Kelas 11](#kelas-11)
  ...
  - [4. Kesetimbangan Kimia (Kc & Kp)](#4-kesetimbangan-kimia-kc-dan-kp)
  - [5. Kesetimbangan Asam–Basa](#5-kesetimbangan-asam-basa)
  - [6. Larutan Garam Terhidrolisis](#6-larutan-garam-terhidrolisis)
  - [7. Larutan Penyangga (Buffer)](#7-larutan-penyangga-buffer)
...
- [Kelas 12](#kelas-12)
  ...
  - [4. Senyawa Turunan Alkana](#4-senyawa-turunan-alkana)
...
Implikasi dari hukum Avogadro adalah bahwa volume gas berbanding lurus dengan jumlah mol gas, sehingga dapat dinyatakan secara matematis:
...
V = volume gas
n = jumlah mol gas
Hukum ini menjadi dasar konsep volume molar gas pada kondisi tertentu. Pada kondisi standar (STP), 1 mol gas menempati volume 22,4 L.
